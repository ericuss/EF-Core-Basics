namespace EF.Core.Contexts.Mapping
{
    ...
    [BuaAmbulanceContext]
    public class AmbulanceDbMappingConfiguration : EntityMappingConfiguration<BuaAmbulance>
    {
        public override void Map(EntityTypeBuilder<BuaAmbulance> entity)
        {
            ...
            entity.HasMany(x => x.Whiners)
                  .WithOne(x => x.Ambulance);

        }

        public override void SeedData(EntityTypeBuilder<BuaAmbulance> entity, IHostingEnvironment env)
        {
